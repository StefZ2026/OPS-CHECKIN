  ...
  events: [
    {
      ...
      roles: [
        ...
        { roleKey: "registration",         displayName: "Registration",       sortOrder: 6 },
        { roleKey: "emcee",                displayName: "Emcee",              sortOrder: 7 },
        { roleKey: "merchandise_sales",    displayName: "Merchandise Sales",  sortOrder: 8 },
        { roleKey: "facilitator",          displayName: "Facilitator",        sortOrder: 9 },
      ],
    },
  ],
};
